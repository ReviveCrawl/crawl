...
const vector<god_power> god_powers[NUM_GODS] =
{
    ...
    // Zin
    { { 1, ABIL_ZIN_RECITE, "진의 율법을 암송할 수 있다" },
      { 2, ABIL_ZIN_VITALISATION, "활력을 진에게 요청할 수 있다" },
      { 3, ABIL_ZIN_IMPRISON, "진께 율법을 따르지 않는 이들을 가두어달라 요청할 수 있다" },
      { 5, ABIL_ZIN_SANCTUARY, "진께 성역을 만들어달라 요청할 수 있다" },
      {-1, ABIL_ZIN_DONATE_GOLD, "진께 성금을 바칠 수 있다" },
      { 7, ABIL_ZIN_CURE_ALL_MUTATIONS,
           "진께서는 당신의 모든 변이를 '단 한번만' 치료해주실 것이다.",
           "진께서는 더 이상 당신의 모든 변이를 치료해주지 않으신다." },
    },

    // TSO
    { { 1, "당신과 당신의 동료는 부정한 것들과 악마들을 죽임으로써 힘을 얻을 수 있다.",
           "당신과 당신의 동료는 더 이상 부정한 것들과 악마들을 죽임으로써 힘을 얻을 수 없다." },
      { 2, ABIL_TSO_DIVINE_SHIELD, "샤이닝 원께 성스러운 방패를 요청할 수 있다" },
      { 4, ABIL_TSO_CLEANSING_FLAME, "정화의 불길 세례를 일으킬 수 있다", },
      { 5, ABIL_TSO_SUMMON_DIVINE_WARRIOR, "성전사를 소환할 수 있다" },
      { 7, ABIL_TSO_BLESS_WEAPON,
           "샤이닝 원께서는 '단 한번만' 신성한 분노로써 당신의 무기를 축복해주실 것이다.",
           "샤이닝 원께서는 더 이상 당신의 무기를 축복해주지 않으신다." },
    },

    // Kikubaaqudgha
    { { 1, ABIL_KIKU_RECEIVE_CORPSES, "키쿠바쿠드하로부터 시체를 하사받을 수 있다" },
      { 2, "키쿠바쿠드하께서는 당신을 잘못된 강령술의 주문과 죽음의 저주로부터 당신을 보호하신다.",
           "키쿠드바쿠드하께서는 더 이상 당신을 잘못된 강령술의 주문과 죽음의 저주로부터 보호하지 않으신다." },
      { 4, "키쿠바쿠드하께서는 불경한 고문으로부터 당신을 보호하신다.",
           "키쿠바쿠드하께서는 더 이상 당신을 불경한 고문으로부터 보호하지 않으신다." },
      { 5, ABIL_KIKU_TORMENT, "시체를 바쳐 고통을 일으킬 수 있다" },
      { 7, ABIL_KIKU_BLESS_WEAPON,
           "키쿠바쿠드하께서는 '단 한번만' 당신에게 '네크로노미콘'을 선사하시거나 혹은 당신의 무기를 '고통'으로 피칠갑해주실 것이다.",
           "키쿠바쿠드하께서는 더 이상 당신의 강령술을 향상시키지 않으신다." },
      { 7, ABIL_KIKU_GIFT_NECRONOMICON,
           "키쿠바쿠드하께서는 당신에게 네크로노미콘을 선사하실 것이다.",
           "키쿠바쿠드하께서는 더 이상 당신의 강령술을 향상시키지 않으신다." },
    },

    // Yredelemnul
    { { 1, ABIL_YRED_ANIMATE_REMAINS, "시체를 되살릴 수 있다" },
      { 2, ABIL_YRED_RECALL_UNDEAD_SLAVES, "당신의 언데드 노예들을 불러들일 수 있다" },
      { 2, ABIL_YRED_INJURY_MIRROR, "당신의 상처를 적들에게 되돌려줄 수 있다" },
      { 3, ABIL_YRED_ANIMATE_DEAD, "군단을 이룰 만큼 많은 시체를 되살릴 수 있다" },
      { 3, "당신의 신앙이 깊어감에 따라, 이레데렘눌께서는 당신에게 시종을 하사하실 것이다.",
           "이레데렘눌께서는 더 이상 당신에게 시종을 하사하지 않으실 것이다." },
      { 4, ABIL_YRED_DRAIN_LIFE, "주위의 생명력을 흡수할 수 있다" },
      { 5, ABIL_YRED_ENSLAVE_SOUL, "살아있는 영혼을 노예로서 예속할 수 있다" },
    },
    ...
    // Vehumet
    { { 1, "살해로부터 마력을 얻을 수 있다" },
      { 3, "베후멧께서는 당신의 파괴 마법을 지원하신다.",
           "베후멧께서는 더 이상 당신의 파괴 마법을 지원하지 않으실 것이다." },
      { 4, "베후멧께서는 당신의 파괴 마법의 사거리를 늘려주실 것이다.",
           "베후멧께서는 더 이상 당신의 파괴 마법의 사거리를 늘려주지 않으실 것이다." },
    },

    // Okawaru
    { { 1, ABIL_OKAWARU_HEROISM, "잠깐 동안 굉장한 기술들을 얻을 수 있다" },
      { 3, "당신의 신앙이 깊어감에 따라, 오카와루께서는 당신에게 탄약을 하사하실 것이다.",
           "오카와루께서는 더 이상 당신에게 탄약을 하사하지 않으실 것이다." },
      { 5, ABIL_OKAWARU_FINESSE, "더 빠르게 공격할 수 있다" },
      { 5, "당신의 신앙이 깊어감에 따라, 오카와루께서는 당신에게 장비품을 하사하실 것이다.",
           "오카와루께서는 더 이상 당신에게 장비품을 하사하지 않으실 것이다." },
    },

    // Makhleb
    { { 1, "살해로부터 체력을 얻을 수 있다" },
      { 2, ABIL_MAKHLEB_MINOR_DESTRUCTION, "마크레브의 파괴적인 힘을 이용할 수 있다" },
      { 3, ABIL_MAKHLEB_LESSER_SERVANT_OF_MAKHLEB, "마크레브의 하급 종복들을 소환할 수 있다" },
      { 4, ABIL_MAKHLEB_MAJOR_DESTRUCTION, "마크레브의 더욱 파괴적인 힘을 퍼부울 수 있다" },
      { 5, ABIL_MAKHLEB_GREATER_SERVANT_OF_MAKHLEB, "마크레브의 고급 종복들을 소환할 수 있다" },
    },

    // Sif Muna
    { { 1, ABIL_SIF_MUNA_DIVINE_ENERGY, "주문을 외울 신의 에너지를 요청할 수 있다 "
                                        "불충분한 마법일 때에는",
           "신의 힘을 요청하라" },
      { 2, "시프 무나께서는 마법을 잘못 영창하여 나타나는 효과로부터 당신을 보호하신다.",
           "시프 무나께서는 마법을 잘못 영창하여 나타나는 효과로부터 당신을 더 이상 보호하지 않으실 것이다." },
      { 3, ABIL_SIF_MUNA_CHANNEL_ENERGY, "시프 무나께 마력을 요청할 수 있다"},
      { 4, ABIL_SIF_MUNA_FORGET_SPELL, "자유롭게 새로운 스펠들을 당신의 마음에 받아들인다",
                                       "너의 의지로 스펠들을 지우라" },
      { 5, "당신의 신앙이 늘어감에 따라 시프 무나께서는 당신에게 책을 선사하실 것이다.",
           "시프 무나께서는 당신에게 더 이상 책을 선사하지 않으실 것이다." },
    },

    // Trog
    {
      { 1, ABIL_TROG_BERSERK, "자신의 의지로 광폭화할 수 있다" },
      { 2, ABIL_TROG_REGEN_MR, "트로그께 재생력과 보호를 요청할 수 있다 "
                               "적대적인 마법으로부터" },
      { 4, ABIL_TROG_BROTHERS_IN_ARMS, "지원군을 부를 수 있다" },
      { 5, "당신의 신앙이 깊어감에 따라, 트로그께서는 당신에게 무기를 하사하실 것이다.",
           "트로그께서는 더 이상 당신에게 무기를 하사하지 않으실 것이다." },
      {-1, ABIL_TROG_BURN_SPELLBOOKS, "트로그께 당신 주변의 마법책들을 불태우기를 요청할 수 있다" },
    },

    // Nemelex
    { { 3, ABIL_NEMELEX_TRIPLE_DRAW, "세 장의 카드를 뽑아 그 중 하나를 선택할 수 있다" },
      { 4, ABIL_NEMELEX_DEAL_FOUR, "네 장의 카드를 한 번에 뽑아서 사용할 수 있다" },
      { 5, ABIL_NEMELEX_STACK_FIVE, "덱의 맨 위의 5장을 원하는 순서대로 정렬하고, 나머지 카드들을 버릴 수 있다",
                                    "덱을 쌓을 수 있다" },
    },

    // Elyvilon
    { { 1, ABIL_ELYVILON_LESSER_HEALING, "당신은 이제 스스로를 소량 치유할 수 있다" },
      { 2, ABIL_ELYVILON_HEAL_OTHER, "당신은 이제 타인을 치유하고 진정시킬 수 있다" },
      { 3, ABIL_ELYVILON_PURIFICATION, "당신은 이제 스스로를 정화할 수 있다." },
      { 4, ABIL_ELYVILON_GREATER_HEALING, "당신은 이제 스스로에게 상당한 양의 치유를 제공할 수 있다" },
      { 5, ABIL_ELYVILON_DIVINE_VIGOUR, "당신은 이제 엘리빌론의 은총을 빌어 자신의 체력과 마력을 증폭시킬 수 있다" },
      { 1, ABIL_ELYVILON_LIFESAVING, "당신은 이제 엘리빌론에게 목숨을 구해 달라 간청할 수 있다" },
    },

    // Lugonu
    { { 1, ABIL_LUGONU_ABYSS_EXIT, "심연에서 떠날 수 있다", "당신의 의지로 심연을 떠날 수 있다" },
      { 2, ABIL_LUGONU_BEND_SPACE, "당신 주변의 공간을 왜곡할 수 있다" },
      { 3, ABIL_LUGONU_BANISH, "당신의 적들을 추방할 수 있다" },
      { 4, ABIL_LUGONU_CORRUPT, "공간을 이루는 기초 구조를 타락시킬 수 있다" },
      { 5, ABIL_LUGONU_ABYSS_ENTER, "원할 때 심연으로 갈 수 있다" },
      { 7, ABIL_LUGONU_BLESS_WEAPON, "루고누께서는 '단 한번만' 당신의 무기를 왜곡으로 타락시키실 것이다.",
                                     "루고누께서는 더 이상 당신의 무기를 타락시키지 않으실 것이다." },
    },

    // Beogh
    { { 2, ABIL_BEOGH_SMITING, "당신의 적들을 강타할 수 있다" },
      { 3, "오크 신봉자들을 모을 수 있다" },
      { 4, ABIL_BEOGH_RECALL_ORCISH_FOLLOWERS, "당신의 오크 신봉자들을 재집합시킬 수 있다" },
      { 5, "물 위를 걸을 수 있다" },
      { 5, ABIL_BEOGH_GIFT_ITEM, "당신의 신봉자들에게 도구를 건네줄 수 있다" },
      { 6, ABIL_BEOGH_RESURRECTION, "쓰러진 오크들을 부활시킬 수 있다" },
    },

    // Jiyva
    { { 1, ABIL_JIYVA_CALL_JELLY, "젤리를 요청할 수 있다" },
      { 3, "지이바께서는 신앙이 늘어남에 따라 당신의 몸을 변이시키실 것이다.",
           "지이바께서는 더 이상 당신의 몸을 변이시키지 않으실 것이다." },
      { 4, ABIL_JIYVA_SLIMIFY, "당신의 적을 슬라임으로 바꿀 수 있다" },
      { 5, "당신은 이제 심각하게 부상당했을 때 젤리를 배출할 것이다.",
           "당신은 부상 당하더라도 더 이상 젤리를 배출하지 않는다." },
      { 5, ABIL_JIYVA_CURE_BAD_MUTATION, "지이바께 당신의 나쁜 변이들을 제거해달라 요청할 수 있다" },
    },

    // Fedhas
    {
      { 0, ABIL_FEDHAS_FUNGAL_BLOOM, "시체를 버섯으로 바꿀 수 있다" },
      { 1, ABIL_FEDHAS_EVOLUTION, "진화를 일으킬 수 있다" },
      { 2, ABIL_FEDHAS_SUNLIGHT, "햇볕을 부를 수 있다" },
      { 3, ABIL_FEDHAS_PLANT_RING, "주위의 식물들이 자라게 만들 수 있다" },
      { 4, ABIL_FEDHAS_SPAWN_SPORES, "폭발성의 포자를 소환할 수 있다" },
      { 5, ABIL_FEDHAS_RAIN, "날씨를 조종할 수 있다" },
    },

    // Cheibriados
    { { 0, ABIL_CHEIBRIADOS_TIME_BEND, "시간을 구부려 다른 이들을 느려지게 만들 수 있다" },
      { 1, "체이브리아도스께서는 당신의 신진대사를 느리고 강하게 만드신다.",
           "체이브리아도스께서는 더 이상 당신의 신진대사를 느리고 강하게 만들지 않으신다." },
      { 3, ABIL_CHEIBRIADOS_DISTORTION, "당신 주변의 시간의 흐름을 일그러뜨릴 수 있다" },
      { 4, ABIL_CHEIBRIADOS_SLOUCH, "과도하게 빠른 적들에게 피해를 가할 수 있다" },
      { 5, ABIL_CHEIBRIADOS_TIME_STEP, "잠깐동안 시간의 흐름에서 벗어날 수 있다" },
    },

    // Ashenzari
    { { 0, ABIL_ASHENZARI_CURSE, "당신의 아이템을 저주할 수 있다" },
      { 1, ABIL_ASHENZARI_SCRYING, "벽 너머를 투시할 수 있다" },
      { 2, "당신이 더 저주받을 수록, 아셴자리께서는 당신의 숙련을 더 지원하실 것이다.",
           "아셴자리께서는 더 이상 당신의 숙련을 지원하지 않으실 것이다." },
      { 3, "아셴자리께서 보이지 않는 것들을 드러내신다.",
           "아셴자리께서는 더 이상 보이지 않는 것들을 드러내지 않으실 것이다." },
      { 4, "아셴자리께서는 당신의 마음을 명석하게 하실 것이다.",
           "아셴자리께서는 더 이상 당신의 마음을 명석하게 하지 않으실 것이다." },
      { 5, ABIL_ASHENZARI_TRANSFER_KNOWLEDGE,
           "아셴자리께서는 당신의 숙련을 재고하도록 도와주실 것이다.",
           "아셴자리께서는 더 이상 당신이 당신의 숙련을 재고하는 것을 돕지 않으실 것이다." },
    },

    // Dithmenos
    { { 2, ABIL_DITHMENOS_SHADOW_STEP, "근처 생명체들에게 도약할 수 있다" },
      { 3, "당신은 이제 때때로 적에게 심한 부상을 입을 때 주변을 덮는 연기를 생성할 수 있다.",
           "당신은 더이상 피해를 입을때 연기를 생성하지 못한다." },
      { 4, "당신의 그림자는 이제 때때로 당신의 행동을 모방할 수 있다.",
           "당신의 그림자는 이제 당신의 행동을 모방하지 않는다." },
      { 5, ABIL_DITHMENOS_SHADOW_FORM, "당신은 이제 소용돌이치는 그림자의 형상으로 변신할 수 있다" },
    },

    // Gozag
    { { 0, ABIL_GOZAG_POTION_PETITION, "고자그께 포션 효과를 청원할 수 있다" },
      { 0, ABIL_GOZAG_CALL_MERCHANT, "던전에 상점을 열도록 상인들을 지원할 수 있다" },
      { 0, ABIL_GOZAG_BRIBE_BRANCH, "뇌물을 먹여 적들의 공격을 막고 동료를 구할 수 있다" },
    },

    // Qazlal
    {
      { 0, "콰즈랄께서 당신이 구름에 의한 피해를 입지 않게 하신다." },
      { 1, "당신은 폭풍으로 둘러싸였다.", "당신의 폭풍은 완전히 사라졌다." },
      { 2, ABIL_QAZLAL_UPHEAVAL, "당신의 적들을 파괴하기 위한 기상 현상을 일으킬 수 있다" },
      { 3, ABIL_QAZLAL_ELEMENTAL_FORCE, "가까이 있는 구름에 생명을 부여할 수 있다." },
      { 4, "당신을 둘러싼 폭풍은 이제 미사일을 격퇴하기에 충분히 강력하다.",
           "당신을 둘러싼 폭풍은 이제 미사일을 격퇴하기에는 너무 약하다." },
      { 4, "당신은 원소에 의한 피해를 받을 때 알맞은 저항으로 적응할 수 있다.",
           "당신은 원소에 의한 피해를 받을 때 더 이상 알맞은 저항으로 적응할 수 없다." },
      { 5, ABIL_QAZLAL_DISASTER_AREA, "당신 주위의 넓은 영역에 대자연의 분노를 부를 수 있다" },
    },

    // Ru
    { { 1, "당신은 당신의 적들을 탈진시키는 힘의 오라를 발산한다.",
           "당신은 더 이상 적들을 탈진시키는 힘의 오라를 발산하지 않는다." },
      { 2, "당신의 힘의 오라는 당신을 해치는 것들을 강타한다.",
           "당신의 힘의 오라는 더 이상 당신을 해치는 것들을 강타하지 않는다." },
      { 3, ABIL_RU_DRAW_OUT_POWER, "당신의 몸을 치료하고, 당신의 마력을 회복할 수 있다" },
      { 4, ABIL_RU_POWER_LEAP, "당신의 힘을 모아 강력한 도약을 할 수 있다" },
      { 5, ABIL_RU_APOCALYPSE, "당신의 적들에 끔찍한 분노를 가할 수 있다" },
    },

    // Pakellas
    {
      { 0, "적을 살해함으로써 마력을 얻을 수 있다" },
      { 1, ABIL_PAKELLAS_QUICK_CHARGE,
        "마력을 사용하여 당신의 도구를 충전할 수 있다" },
      { 3, ABIL_PAKELLAS_DEVICE_SURGE,
        "마력을 사용하여 당신의 도구를 강화할 수 있다" },
      { 7, ABIL_PAKELLAS_SUPERCHARGE,
        "파켈라스께서는 '단 한번만' 마법봉을 강력하게 충전해주실 것이다.",
        "파켈라스께서는 더 이상 마법봉을 강력히 충전해주지 않으신다." },
    },

    // Uskayaw
    {
      { 1, ABIL_USKAYAW_STOMP, "박자에 맞춰 발을 강하게 구를 수 있다" },
      { 2, ABIL_USKAYAW_LINE_PASS, "일직선상의 다른 춤꾼들을 통과할 수 있다" },
      { 3, "우스카요께서는 당신의 적들이 넋을 놓고 당신의 춤을 구경하도록 만드실 것이다.",
        "우스카요께서는 더 이상 당신의 적들이 넋을 놓고 당신의 춤을 구경하도록 만들지 않으실 것이다."},
      { 4, "우스카요께서는 당신의 적들이 다함께 고통을 느끼도록 만드실 것이다.",
        "우스카요께서는 더 이상 당신의 적들이 다함께 고통을 느끼도록 만들지 않으실 것이다."},
      { 5, ABIL_USKAYAW_GRAND_FINALE, "선택한 희생자와 어우러짐으로써 그를 완전히 파괴할 수 있다" },
    },

    // Hepliaklqana
    { { 0, ABIL_HEPLIAKLQANA_RECALL, "당신의 선조를 불러올 수 있다" },
      { 0, ABIL_HEPLIAKLQANA_IDENTITY, "당신은 이제 선조의 정체성을 기억해낼 수 있다" },
      { 3, ABIL_HEPLIAKLQANA_TRANSFERENCE, "당신은 이제 지정한 존재의 위치를 선조와 뒤바꿀 수 있다" },
      { 4, ABIL_HEPLIAKLQANA_IDEALISE, "당신은 이제 조상을 치료하고 보호할 수 있다" },
      { 5, "당신은 이제 선조를 이전시킬 시 주위의 적들을 Drain 상태로 만들 수 있다"},
    },

    // Wu Jian
    { { 1, "몬스터 근처에서 이동하면서 그들을 공격할 수 있다",
           "더 이상 회전 공격을 구사할 수 없다" },
      { 2, "딱딱한 장애물 쪽으로 움직임으로써 적의 주의를 돌리는 공중 공격을 구사할 수 있다",
           "더 이상 공중 공격을 구사할 수 없다" },
      { 3, "적들을 향해 움직이면서 공격할 수 있으며, 이 공격으로 부주의한 적에게 치명적인 타격을 줄 수 있다",
           "더 이상 돌진 공격을 구사할 수 없다" },
      { 4, ABIL_WU_JIAN_SERPENTS_LASH, "잠시 초자연적인 속도로 움직일 수 있다" },
      { 5, ABIL_WU_JIAN_HEAVENLY_STORM, "천국의 구름 무리를 불러내어 당신의 공격을 강화할 수 있다" },
    },
};
