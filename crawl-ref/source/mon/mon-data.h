...

{
    ...
    M_NO_SKELETON | M_BATTY | M_NO_POLY_TO | M_UNFINISHED,
    MR_VUL_POISON,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO | M_UNFINISHED,
    mrd(MR_RES_FIRE, 3),
...

{
    ...
    M_NO_SKELETON | M_NO_POLY_TO | M_UNFINISHED,
    MR_NO_FLAGS,
...

{
    ...
    M_NO_EXP_GAIN | M_STATIONARY | M_NO_POLY_TO | M_UNFINISHED,
    MR_RES_POISON,
...

{
    ...
    M_STATIONARY | M_NO_EXP_GAIN | M_UNFINISHED,
    MR_RES_POISON | MR_VUL_FIRE,
...

{
    ...
    M_SENSE_INVIS | M_SPELLCASTER | M_FAKE_SPELLS | M_UNFINISHED,
    MR_RES_POISON | MR_VUL_FIRE,
...

{
    ...
    M_SPELLCASTER | M_FAKE_SPELLS | M_UNFINISHED,
    MR_RES_POISON | MR_VUL_FIRE,
...

{
    ...
    M_SPELLCASTER | M_FAKE_SPELLS | M_CONFUSED | M_UNFINISHED,
    MR_RES_POISON,
